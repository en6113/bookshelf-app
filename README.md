...
ログイン不要で書籍一覧、書籍詳細（レビュー含む）、ランキングの閲覧が可能で、ログインユーザーは書籍の登録やコミュニティ機能（レビュー投稿・いいね）及び読書管理機能（お気に入り・読書計画作成）を使用することができます。
...
![ER図](.github/images/20260718_erd.png)
